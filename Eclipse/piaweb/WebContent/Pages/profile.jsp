        ...
        <div class="middle-container">
            ...
            <div class="profile-content">
                <div class="profile-options">
                    ...
                    <a class="block-profile option-selected " href="${linkProfileQuestions}"><span>${totalOfQuestions}</span>Preguntas</a>
                    ...
                    <a class="block-profile " href="${linkProfileAnswers}"><span>${totalOfAnswers}</span>Respuestas</a>
                ...
                <% for(QuestionDetailsViewModel pregunta : preguntas) { %>
          		...
          		<%if(pageNumber != 1) {%>
            		<a href="/piaweb/Perfil/Preguntas?userID=<%=userProfile.getID_Usuario()%>&pageNumber=<%=pageNumber -1 %>" class="btn-change-page">
           		 &lt;</a>
           			 <%} %>
          		  <%if(pageNumber != numberOfPages){ %>
          			  <a href="/piaweb/Perfil/Preguntas?userID=<%=userProfile.getID_Usuario()%>&pageNumber=<%=pageNumber +1 %>" class="btn-change-page btn-next-page">&gt;</a>
        		  <%} %>
       			 </div>
