        ...
        <div class="middle-container">
            ...
            <div class="profile-content">
                  ...
                  <div class="profile-options">
                    ...
                    <a class="block-profile option-selected " href="${linkProfileFavorites}"><span>${totalOfFavs} </span>Favoritos</a>
               ...
               <div class="profile-stuff">
                ...
                <% for(QuestionDetailsViewModel pregunta : preguntas) { %>
            		...
            		<a href="/piaweb/Perfil/Favoritos?userID=<%=userProfile.getID_Usuario()%>&pageNumber=<%=pageNumber -1 %>" class="btn-change-page">
           		 &lt;</a>
           			 <%} %>
          		  <%if(pageNumber != numberOfPages){ %>
          			  <a href="/piaweb/Perfil/Favoritos?userID=<%=userProfile.getID_Usuario()%>&pageNumber=<%=pageNumber +1 %>" class="btn-change-page btn-next-page">&gt;</a>
        		  <%} %>
       			 </div>
