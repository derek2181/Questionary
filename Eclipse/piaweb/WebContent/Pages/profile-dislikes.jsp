        ...
        <div class="middle-container">
            ...
            <div class="profile-content">
               ...
               <div class="profile-options">
                    ...
                    <a class="block-profile option-selected" href="${linkProfileDislikes}"><span>${totalOfDislikes}</span>Dislikes</a>
                     	<% } %> 
                </div>
            ...
            <div class="profile-stuff">
                ...
                <% for(QuestionDetailsViewModel pregunta : preguntas) { %>
          		...
          		<%if(pageNumber != 1) {%>
            		<a href="/piaweb/Perfil/Usuario?userID=<%=userProfile.getID_Usuario()%>&pageNumber=<%=pageNumber -1 %>" class="btn-change-page">
           		 &lt;</a>
           			 <%} %>
          		  <%if(pageNumber != numberOfPages){ %>
          			  <a href="/piaweb/Perfil/Usuario?userID=<%=userProfile.getID_Usuario()%>&pageNumber=<%=pageNumber +1 %>" class="btn-change-page btn-next-page">&gt;</a>
        		  <%} %>
       			 </div>
